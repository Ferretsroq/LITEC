...
S:LLab_2.FUNCTION_Da$Guess_Array$1$100({3}DG,SI:S),E,0,0
S:LLab_2.FUNCTION_Da$amber_score$1$100({1}SC:U),E,0,0
S:LLab_2.FUNCTION_Da$Mastermind_Array$1$100({3}DG,SI:S),R,0,0,[r5,r6,r7]
S:LLab_2.FUNCTION_Db$Guess_Array$1$105({3}DG,SI:S),E,0,0
S:LLab_2.FUNCTION_Db$green_score$1$105({1}SC:U),E,0,0
S:LLab_2.FUNCTION_Db$Mastermind_Array$1$105({3}DG,SI:S),R,0,0,[r5,r6,r7]
...
S:FLab_2$__str_2$0$0({21}DA21d,SC:S),D,0,0
S:FLab_2$__str_3$0$0({21}DA21d,SC:S),D,0,0
S:FLab_2$__str_4$0$0({20}DA20d,SC:S),D,0,0
S:FLab_2$__str_5$0$0({22}DA22d,SC:S),D,0,0
S:FLab_2$__str_6$0$0({20}DA20d,SC:S),D,0,0
S:FLab_2$__str_7$0$0({20}DA20d,SC:S),D,0,0
S:FLab_2$__str_8$0$0({35}DA35d,SC:S),D,0,0
S:FLab_2$__str_9$0$0({2}DA2d,SC:S),D,0,0
S:FLab_2$__str_10$0$0({3}DA3d,SC:S),D,0,0
S:FLab_2$__str_11$0$0({4}DA4d,SC:S),D,0,0
S:FLab_2$__str_12$0$0({11}DA11d,SC:S),D,0,0
S:FLab_2$__str_13$0$0({19}DA19d,SC:S),D,0,0
S:FLab_2$__str_14$0$0({2}DA2d,SC:S),D,0,0
S:FLab_2$__str_15$0$0({19}DA19d,SC:S),D,0,0
S:FLab_2$__str_16$0$0({31}DA31d,SC:S),D,0,0
