...
F:G$GENERATE_MASTERMIND_ARRAY$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$FUNCTION_A$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$FUNCTION_B$0$0({2}DF,SC:S),Z,0,0,0,0,0
F:G$FUNCTION_C$0$0({2}DF,SC:S),Z,0,0,0,0,0
F:G$FUNCTION_Da$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$FUNCTION_Db$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$FUNCTION_E$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$FUNCTION_F$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$FUNCTION_G$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
F:G$Start_Button$0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$Switch_A0$0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$Switch_A1$0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$Switch_B0$0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$Switch_B1$0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$Switch_C0$0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$Switch_C1$0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$Debugging$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:LLab_2.getchar$c$1$10({1}SC:S),R,0,0,[]
S:G$Counts$0$0({2}SI:U),E,0,0
S:G$Seconds$0$0({1}SC:U),E,0,0
S:G$amber_score$0$0({1}SC:U),E,0,0
S:G$green_score$0$0({1}SC:U),E,0,0
S:G$points$0$0({1}SC:U),E,0,0
S:G$result$0$0({1}SC:U),E,0,0
S:G$i$0$0({2}SI:S),E,0,0
S:G$MA_0$0$0({1}SC:U),E,0,0
S:G$MA_1$0$0({1}SC:U),E,0,0
S:G$MA_2$0$0({1}SC:U),E,0,0
S:G$GA_0$0$0({1}SC:U),E,0,0
S:G$GA_1$0$0({1}SC:U),E,0,0
S:G$GA_2$0$0({1}SC:U),E,0,0
S:G$buzzer_delay$0$0({2}SI:S),E,0,0
S:G$number_of_correct_colors$0$0({1}SC:U),E,0,0
S:G$number_of_correct_spots$0$0({1}SC:U),E,0,0
S:G$TMAX$0$0({1}SC:U),E,0,0
S:G$timer$0$0({1}SC:U),E,0,0
S:G$Mastermind_Array$0$0({6}DA3d,SI:S),E,0,0
S:G$Guess_Array$0$0({6}DA3d,SI:S),E,0,0
S:G$MA_Copy$0$0({6}DA3d,SI:S),E,0,0
S:LLab_2.GENERATE_MASTERMIND_ARRAY$Mastermind_Array$1$79({3}DG,SI:S),R,0,0,[r5,r6,r7]
S:LLab_2.FUNCTION_Da$Guess_Array$1$108({3}DG,SI:S),E,0,0
S:LLab_2.FUNCTION_Da$amber_score$1$108({1}SC:U),E,0,0
S:LLab_2.FUNCTION_Da$Mastermind_Array$1$108({3}DG,SI:S),R,0,0,[r5,r6,r7]
S:LLab_2.FUNCTION_Db$Guess_Array$1$113({3}DG,SI:S),E,0,0
S:LLab_2.FUNCTION_Db$green_score$1$113({1}SC:U),E,0,0
S:LLab_2.FUNCTION_Db$Mastermind_Array$1$113({3}DG,SI:S),R,0,0,[r5,r6,r7]
...
S:G$BILEDA0$0$0({1}SX:U),J,0,0
S:G$BILEDA1$0$0({1}SX:U),J,0,0
S:G$SWITCHA0$0$0({1}SX:U),J,0,0
S:G$SWITCHA1$0$0({1}SX:U),J,0,0
S:G$BILEDB0$0$0({1}SX:U),J,0,0
S:G$BILEDB1$0$0({1}SX:U),J,0,0
S:G$SWITCHB0$0$0({1}SX:U),J,0,0
S:G$SWITCHB1$0$0({1}SX:U),J,0,0
S:G$BILEDC0$0$0({1}SX:U),J,0,0
S:G$BILEDC1$0$0({1}SX:U),J,0,0
S:G$SWITCHC0$0$0({1}SX:U),J,0,0
S:G$SWITCHC1$0$0({1}SX:U),J,0,0
S:G$AMBER$0$0({1}SX:U),J,0,0
S:G$GREEN$0$0({1}SX:U),J,0,0
S:G$BUZZER$0$0({1}SX:U),J,0,0
S:G$BUTTON$0$0({1}SX:U),J,0,0
...
S:FLab_2$__str_0$0$0({72}DA72d,SC:S),D,0,0
S:FLab_2$__str_1$0$0({21}DA21d,SC:S),D,0,0
S:FLab_2$__str_2$0$0({10}DA10d,SC:S),D,0,0
S:FLab_2$__str_3$0$0({22}DA22d,SC:S),D,0,0
S:FLab_2$__str_4$0$0({21}DA21d,SC:S),D,0,0
S:FLab_2$__str_5$0$0({3}DA3d,SC:S),D,0,0
S:FLab_2$__str_6$0$0({2}DA2d,SC:S),D,0,0
S:FLab_2$__str_7$0$0({20}DA20d,SC:S),D,0,0
S:FLab_2$__str_8$0$0({21}DA21d,SC:S),D,0,0
S:FLab_2$__str_9$0$0({20}DA20d,SC:S),D,0,0
S:FLab_2$__str_10$0$0({20}DA20d,SC:S),D,0,0
S:FLab_2$__str_11$0$0({20}DA20d,SC:S),D,0,0
S:FLab_2$__str_12$0$0({20}DA20d,SC:S),D,0,0
S:FLab_2$__str_13$0$0({35}DA35d,SC:S),D,0,0
S:FLab_2$__str_14$0$0({2}DA2d,SC:S),D,0,0
S:FLab_2$__str_15$0$0({4}DA4d,SC:S),D,0,0
S:FLab_2$__str_16$0$0({11}DA11d,SC:S),D,0,0
S:FLab_2$__str_17$0$0({19}DA19d,SC:S),D,0,0
S:FLab_2$__str_18$0$0({19}DA19d,SC:S),D,0,0
S:FLab_2$__str_19$0$0({31}DA31d,SC:S),D,0,0
