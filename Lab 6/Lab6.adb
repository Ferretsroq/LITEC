...
S:LLab6.Pick_Steering_Gain$input$1$143({1}SC:S),R,0,0,[r7]
S:LLab6.Hand_Check$temp_int$1$146({2}SI:S),R,0,0,[r6,r7]
S:LLab6.Pick_Heading$input$1$150({1}SC:S),R,0,0,[r7]
S:LLab6.read_ranger$addr$1$153({1}SC:U),R,0,0,[]
S:LLab6.read_ranger$st_range$1$153({2}SI:U),R,0,0,[r6,r7]
...
S:FLab6$__str_9$0$0({25}DA25d,SC:S),D,0,0
