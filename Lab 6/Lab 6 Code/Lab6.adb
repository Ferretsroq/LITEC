...
S:G$time$0$0({2}SI:U),E,0,0
S:LLab6.Pick_Heading$input$1$148({1}SC:S),R,0,0,[r7]
S:LLab6.read_compass$addr$1$152({1}SC:U),R,0,0,[]
S:LLab6.read_compass$Data$1$152({2}DA2d,SC:U),E,0,0
S:LLab6.read_compass$read_heading$1$152({2}SI:U),R,0,0,[]
S:LLab6.read_ranger$addr$1$154({1}SC:U),R,0,0,[]
S:LLab6.read_ranger$st_range$1$154({2}SI:U),R,0,0,[r6,r7]
S:LLab6.set_PW$temp_motorpw$1$156({4}SL:S),R,0,0,[r4,r5,r6,r7]
S:LLab6.set_PW$sloc0$1$0({4}SL:S),E,0,0
S:LLab6.Set_Desired_Heading$temp_heading$1$158({2}SI:S),R,0,0,[r6,r7]
S:LLab6.Pick_Heading_kp$input$1$160({1}SC:S),R,0,0,[r7]
S:LLab6.Pick_Heading_kd$input$1$163({1}SC:S),R,0,0,[r7]
S:LLab6.Set_Fan_Angle$input$1$166({1}SC:S),R,0,0,[r7]
...
S:FLab6$__str_6$0$0({49}DA49d,SC:S),D,0,0
S:FLab6$__str_7$0$0({17}DA17d,SC:S),D,0,0
