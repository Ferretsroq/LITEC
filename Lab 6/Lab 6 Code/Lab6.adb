...
S:LLab6.read_compass$addr$1$155({1}SC:U),R,0,0,[]
S:LLab6.read_compass$Data$1$155({2}DA2d,SC:U),E,0,0
S:LLab6.read_compass$read_heading$1$155({2}SI:U),R,0,0,[]
S:LLab6.read_ranger$addr$1$157({1}SC:U),R,0,0,[]
S:LLab6.read_ranger$st_range$1$157({2}SI:U),R,0,0,[r6,r7]
S:LLab6.set_PW$temp_motorpw$1$159({4}SL:S),R,0,0,[r4,r5,r6,r7]
S:LLab6.set_PW$sloc0$1$0({4}SL:S),E,0,0
S:LLab6.Pick_Heading_kp$input$1$163({1}SC:S),R,0,0,[r7]
S:LLab6.Pick_Heading_kd$input$1$166({1}SC:S),R,0,0,[r7]
S:LLab6.Set_Fan_Angle$input$1$169({1}SC:S),R,0,0,[r7]
