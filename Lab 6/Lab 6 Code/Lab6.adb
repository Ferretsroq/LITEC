...
F:G$Pick_Steering_Gain$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$Hand_Check$0$0({2}DF,SC:S),Z,0,0,0,0,0
...
F:G$Set_Desired_Heading$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Pick_Heading_kp$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Pick_Heading_kd$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Set_Fan_Angle$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:G$left_pw$0$0({2}SI:S),E,0,0
S:G$right_pw$0$0({2}SI:S),E,0,0
...
S:G$new_AD$0$0({1}SC:U),E,0,0
S:G$new_heading$0$0({1}SC:U),E,0,0
S:G$h_count$0$0({1}SC:U),E,0,0
S:G$r_count$0$0({1}SC:U),E,0,0
S:G$adc_count$0$0({1}SC:U),E,0,0
S:G$steer_gain$0$0({4}SF:S),E,0,0
S:G$drive_gain$0$0({4}SF:S),E,0,0
S:G$DRIVE_PW$0$0({2}SI:U),E,0,0
...
S:G$heading_kp$0$0({1}SC:U),E,0,0
S:G$heading_kd$0$0({1}SC:U),E,0,0
S:LLab6.Pick_Steering_Gain$input$1$149({1}SC:S),R,0,0,[r7]
S:LLab6.Hand_Check$temp_int$1$152({2}SI:S),R,0,0,[r6,r7]
S:LLab6.Pick_Heading$input$1$155({1}SC:S),R,0,0,[r7]
S:LLab6.read_compass$addr$1$158({1}SC:U),R,0,0,[]
S:LLab6.read_compass$Data$1$158({2}DA2d,SC:U),E,0,0
S:LLab6.read_compass$read_heading$1$158({2}SI:U),R,0,0,[]
S:LLab6.read_ranger$addr$1$160({1}SC:U),R,0,0,[]
S:LLab6.read_ranger$st_range$1$160({2}SI:U),R,0,0,[r6,r7]
S:LLab6.set_PW$temp_motorpw$1$162({4}SL:S),R,0,0,[r4,r5,r6,r7]
S:LLab6.set_PW$sloc0$1$0({4}SL:S),E,0,0
S:LLab6.Pick_Heading_kp$input$1$166({1}SC:S),R,0,0,[r7]
S:LLab6.Pick_Heading_kd$input$1$169({1}SC:S),R,0,0,[r7]
S:LLab6.Set_Fan_Angle$input$1$172({1}SC:S),R,0,0,[r7]
...
S:G$accelerometer_adjustment$0$0({2}DF,SV:S),C,0,0
S:G$read_accel$0$0({2}DF,SV:S),C,0,0
S:G$main$0$0({2}DF,SV:S),C,0,0
S:G$Pick_Steering_Gain$0$0({2}DF,SV:S),C,0,0
...
S:FLab6$__str_4$0$0({18}DA18d,SC:S),D,0,0
S:FLab6$__str_5$0$0({43}DA43d,SC:S),D,0,0
S:FLab6$__str_6$0$0({37}DA37d,SC:S),D,0,0
S:FLab6$__str_7$0$0({18}DA18d,SC:S),D,0,0
S:FLab6$__str_8$0$0({41}DA41d,SC:S),D,0,0
S:FLab6$__str_9$0$0({56}DA56d,SC:S),D,0,0
S:FLab6$__str_10$0$0({20}DA20d,SC:S),D,0,0
S:FLab6$__str_11$0$0({31}DA31d,SC:S),D,0,0
S:FLab6$__str_12$0$0({35}DA35d,SC:S),D,0,0
S:FLab6$__str_13$0$0({68}DA68d,SC:S),D,0,0
S:FLab6$__str_14$0$0({22}DA22d,SC:S),D,0,0
S:FLab6$__str_15$0$0({38}DA38d,SC:S),D,0,0
S:FLab6$__str_16$0$0({52}DA52d,SC:S),D,0,0
S:FLab6$__str_17$0$0({25}DA25d,SC:S),D,0,0
S:FLab6$__str_18$0$0({38}DA38d,SC:S),D,0,0
S:FLab6$__str_19$0$0({54}DA54d,SC:S),D,0,0
S:FLab6$__str_20$0$0({25}DA25d,SC:S),D,0,0
S:FLab6$__str_21$0$0({65}DA65d,SC:S),D,0,0
S:FLab6$__str_22$0$0({9}DA9d,SC:S),D,0,0
