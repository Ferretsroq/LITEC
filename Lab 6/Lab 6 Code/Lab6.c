...
/*	if(((Error - prev_error) > -5) && ((Error - prev_error) < 5))
	{
		error_difference = 0;
	}*/
//	else error_difference = (Error - prev_error);
	// actual calculation for the pulse width
//	temp_motorpw = (long)((heading_kp)*(long)(Error)) + ((long)(heading_kd)*(long)(error_difference));
