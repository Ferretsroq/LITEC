...
S:LSooooLab_4.Pick_Heading$user_heading$1$138({2}SI:S),R,0,0,[r6,r7]
S:LSooooLab_4.Pick_Compass_Gain$user_gain$1$142({2}SI:S),R,0,0,[r6,r7]
S:LSooooLab_4.read_compass$addr$1$144({1}SC:U),R,0,0,[]
S:LSooooLab_4.read_compass$Data$1$144({2}DA2d,SC:U),E,0,0
S:LSooooLab_4.read_compass$read_heading$1$144({2}SI:U),R,0,0,[]
S:LSooooLab_4.read_ranger$addr$1$146({1}SC:U),R,0,0,[]
S:LSooooLab_4.read_ranger$Data$1$146({2}DA2d,SC:U),E,0,0
S:LSooooLab_4.read_ranger$range$1$146({2}SI:U),R,0,0,[r6,r7]
S:LSooooLab_4.Pick_Ranger_Gain$input_gain$1$152({1}SC:S),R,0,0,[r6]
S:LSooooLab_4.compass_error$heading$1$153({2}SI:U),R,0,0,[r6,r7]
S:LSooooLab_4.compass_error$Error$1$154({2}SI:S),R,0,0,[r6,r7]
S:LSooooLab_4.compass_error$PWMe$1$154({2}SI:U),R,0,0,[r6,r7]
S:LSooooLab_4.compass_error$k$1$154({1}SC:U),R,0,0,[r5]
...
S:FSooooLab_4$__str_8$0$0({41}DA41d,SC:S),D,0,0
S:FSooooLab_4$__str_9$0$0({38}DA38d,SC:S),D,0,0
S:FSooooLab_4$__str_10$0$0({41}DA41d,SC:S),D,0,0
S:FSooooLab_4$__str_11$0$0({47}DA47d,SC:S),D,0,0
S:FSooooLab_4$__str_12$0$0({20}DA20d,SC:S),D,0,0
