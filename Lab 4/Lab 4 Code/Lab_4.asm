...
;--------------------------------------------------------
	...
	.globl _RANGER_MIN
	.globl _RANGER_MAX
	.globl _RANGER_CENTER
	.globl _COMPASS_MIN
	.globl _COMPASS_MAX
	.globl _COMPASS_CENTER
...
;--------------------------------------------------------
	.area DSEG    (DATA)
LLab_4.lcd_clear$NumBytes$1$77==.
_lcd_clear_NumBytes_1_77:
	.ds 1
LLab_4.lcd_clear$Cmd$1$77==.
_lcd_clear_Cmd_1_77:
	.ds 2
LLab_4.read_keypad$Data$1$78==.
_read_keypad_Data_1_78:
	.ds 2
LLab_4.i2c_write_data$start_reg$1$97==.
_i2c_write_data_PARM_2:
	.ds 1
LLab_4.i2c_write_data$buffer$1$97==.
_i2c_write_data_PARM_3:
	.ds 3
LLab_4.i2c_write_data$num_bytes$1$97==.
_i2c_write_data_PARM_4:
	.ds 1
LLab_4.i2c_read_data$start_reg$1$99==.
_i2c_read_data_PARM_2:
	.ds 1
LLab_4.i2c_read_data$buffer$1$99==.
_i2c_read_data_PARM_3:
	.ds 3
LLab_4.i2c_read_data$num_bytes$1$99==.
_i2c_read_data_PARM_4:
	.ds 1
LLab_4.Accel_Init$Data2$1$103==.
_Accel_Init_Data2_1_103:
	.ds 1
G$COMPASS_CENTER$0$0==.
_COMPASS_CENTER::
	.ds 2
G$COMPASS_MAX$0$0==.
_COMPASS_MAX::
...
_speed::
	.ds 1
LLab_4.read_compass$Data$1$141==.
_read_compass_Data_1_141:
	.ds 2
LLab_4.read_ranger$Data$1$146==.
...
;Data                      Allocated with name '_read_compass_Data_1_141'
...
;	C:\Users\rutmas\Documents\LITEC\LITEC\Lab 4\Lab 4 Code\Lab_4.c:254: return input_heading;
	...
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'servo_error'
;------------------------------------------------------------
...
;	C:\Users\rutmas\Documents\LITEC\LITEC\Lab 4\Lab 4 Code\Lab_4.c:268: return PWMe;
	...
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'motor_error'
;------------------------------------------------------------
;range                     Allocated to registers r6 r7 
;Error                     Allocated to registers r6 r7 
...
;	C:\Users\rutmas\Documents\LITEC\LITEC\Lab 4\Lab 4 Code\Lab_4.c:294: return input_gain;
	...
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'input_speed'
;------------------------------------------------------------
;desired_speed             Allocated to registers r6 
;------------------------------------------------------------
	G$input_speed$0$0 ==.
	C$Lab_4.c$297$1$157 ==.
...
___str_4:
	.db 0x0D
	.ascii "Input desired heading on keypad, in degrees."
	.db 0x0A
	.db 0x00
FLab_4$__str_5$0$0 == .
___str_5:
	.db 0x0D
	.ascii "Any number above 360 will be interpreted as 360."
	.db 0x0A
	.db 0x00
FLab_4$__str_6$0$0 == .
___str_6:
...
___str_10:
	.db 0x0D
	.ascii "Input desired speed setting, between 0 and 10. Note that 0 "
	.ascii "will leave the motor still."
	.db 0x0A
	.db 0x00
FLab_4$__str_11$0$0 == .
___str_11:
	.db 0x0D
	.ascii "Any number below 0 will be interpreted as 0. Any number abo"
	.ascii "ve 10 will be 10."
	.db 0x0A
	.db 0x00
FLab_4$__str_12$0$0 == .
___str_12:
	.db 0x0D
	.ascii "Desired speed is %u"
	.db 0x00
	.area XINIT   (CODE)
	.area CABS    (ABS,CODE)
