...
S:LLab_4.main$run_stop$1$118({1}SC:U),R,0,0,[r7]
S:LLab_4.read_compass$addr$1$139({1}SC:U),R,0,0,[]
S:LLab_4.read_compass$Data$1$139({2}DA2d,SC:U),E,0,0
S:LLab_4.read_compass$read_heading$1$139({2}SI:U),R,0,0,[]
S:LLab_4.read_ranger$addr$1$144({1}SC:U),R,0,0,[]
S:LLab_4.read_ranger$Data$1$144({2}DA2d,SC:U),E,0,0
S:LLab_4.read_ranger$range$1$144({2}SI:U),R,0,0,[r6,r7]
S:LLab_4.pick_heading$input_heading$1$149({2}SI:U),R,0,0,[r6,r7]
S:LLab_4.servo_error$heading$1$150({2}SI:U),R,0,0,[r6,r7]
S:LLab_4.servo_error$Error$1$151({2}SI:S),R,0,0,[r6,r7]
S:LLab_4.servo_error$PWMe$1$151({2}SI:U),R,0,0,[r6,r7]
S:LLab_4.servo_error$k$1$151({1}SC:U),R,0,0,[r5]
S:LLab_4.motor_error$range$1$152({2}SI:U),R,0,0,[r6,r7]
S:LLab_4.motor_error$Error$1$153({2}SI:S),R,0,0,[r6,r7]
S:LLab_4.motor_error$PWMe$1$153({2}SI:U),R,0,0,[r4,r5]
S:LLab_4.motor_error$k$1$153({1}SC:U),R,0,0,[]
...
S:G$pick_range$4$121({2}DF,SI:S),C,0,0
S:G$set_range_adj$3$123({2}DF,SI:S),C,0,0
