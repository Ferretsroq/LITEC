...
F:G$servo_error$0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$motor_error$0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$steering_gain$0$0({2}DF,SC:S),C,0,0,0,0,0
F:G$input_speed$0$0({2}DF,SC:S),Z,0,0,0,0,0
S:LLab_4.getchar$c$1$10({1}SC:S),R,0,0,[]
S:LLab_4.lcd_clear$NumBytes$1$77({1}SC:U),E,0,0
S:LLab_4.lcd_clear$Cmd$1$77({2}DA2d,SC:U),E,0,0
S:LLab_4.read_keypad$i$1$78({1}SC:U),R,0,0,[r7]
S:LLab_4.read_keypad$Data$1$78({2}DA2d,SC:U),E,0,0
S:LLab_4.kpd_input$mode$1$80({1}SC:S),R,0,0,[r7]
S:LLab_4.kpd_input$sum$1$81({2}SI:U),R,0,0,[r5,r6]
S:LLab_4.kpd_input$key$1$81({1}SC:S),R,0,0,[r3]
S:LLab_4.kpd_input$i$1$81({1}SC:S),R,0,0,[]
S:LLab_4.i2c_write_data$start_reg$1$97({1}SC:U),E,0,0
S:LLab_4.i2c_write_data$buffer$1$97({3}DG,SC:U),E,0,0
S:LLab_4.i2c_write_data$num_bytes$1$97({1}SC:U),E,0,0
S:LLab_4.i2c_write_data$addr$1$97({1}SC:U),R,0,0,[r7]
S:LLab_4.i2c_write_data$i$1$98({1}SC:U),R,0,0,[]
S:LLab_4.i2c_read_data$start_reg$1$99({1}SC:U),E,0,0
S:LLab_4.i2c_read_data$buffer$1$99({3}DG,SC:U),E,0,0
S:LLab_4.i2c_read_data$num_bytes$1$99({1}SC:U),E,0,0
S:LLab_4.i2c_read_data$addr$1$99({1}SC:U),R,0,0,[r7]
S:LLab_4.i2c_read_data$j$1$100({1}SC:U),R,0,0,[]
S:LLab_4.Accel_Init$Data2$1$103({1}DA1d,SC:U),E,0,0
S:G$COMPASS_CENTER$0$0({2}SI:U),E,0,0
S:G$COMPASS_MAX$0$0({2}SI:U),E,0,0
S:G$COMPASS_MIN$0$0({2}SI:U),E,0,0
S:G$RANGER_CENTER$0$0({2}SI:U),E,0,0
S:G$RANGER_MAX$0$0({2}SI:U),E,0,0
S:G$RANGER_MIN$0$0({2}SI:U),E,0,0
...
S:G$heading_delay$0$0({1}SC:U),E,0,0
S:G$COMPASS_PW$0$0({2}SI:U),E,0,0
S:G$RANGER_PW$0$0({2}SI:U),E,0,0
S:G$compass_gain$0$0({1}SC:U),E,0,0
S:G$speed$0$0({1}SC:U),E,0,0
S:LLab_4.main$run_stop$1$120({1}SC:U),R,0,0,[r7]
S:LLab_4.read_compass$addr$1$141({1}SC:U),R,0,0,[]
S:LLab_4.read_compass$Data$1$141({2}DA2d,SC:U),E,0,0
S:LLab_4.read_compass$read_heading$1$141({2}SI:U),R,0,0,[]
S:LLab_4.read_ranger$addr$1$146({1}SC:U),R,0,0,[]
S:LLab_4.read_ranger$Data$1$146({2}DA2d,SC:U),E,0,0
S:LLab_4.read_ranger$range$1$146({2}SI:U),R,0,0,[r6,r7]
S:LLab_4.pick_heading$input_heading$1$151({2}SI:U),R,0,0,[r6,r7]
S:LLab_4.servo_error$heading$1$152({2}SI:U),R,0,0,[r6,r7]
S:LLab_4.servo_error$Error$1$153({2}SI:S),R,0,0,[r6,r7]
S:LLab_4.servo_error$PWMe$1$153({2}SI:U),R,0,0,[r6,r7]
S:LLab_4.servo_error$k$1$153({1}SC:U),R,0,0,[r5]
S:LLab_4.motor_error$range$1$154({2}SI:U),R,0,0,[r6,r7]
S:LLab_4.motor_error$Error$1$155({2}SI:S),R,0,0,[r6,r7]
S:LLab_4.motor_error$PWMe$1$155({2}SI:U),R,0,0,[r4,r5]
S:LLab_4.motor_error$k$1$155({1}SC:U),R,0,0,[]
S:LLab_4.steering_gain$input_gain$1$157({1}SC:S),R,0,0,[r6]
S:LLab_4.input_speed$desired_speed$1$159({1}SC:S),R,0,0,[r6]
S:LLab_4.lcd_print$text$1$73({80}DA80d,SC:U),F,0,0
...
S:G$heading_gain$0$0({2}DF,SC:S),C,0,0
S:G$main$0$0({2}DF,SV:S),C,0,0
S:G$pick_range$4$123({2}DF,SI:S),C,0,0
S:G$set_range_adj$3$125({2}DF,SI:S),C,0,0
S:G$steering_gain$0$0({2}DF,SC:S),C,0,0
S:FLab_4$__str_0$0$0({22}DA22d,SC:S),D,0,0
S:FLab_4$__str_1$0$0({16}DA16d,SC:S),D,0,0
S:FLab_4$__str_2$0$0({3}DA3d,SC:S),D,0,0
S:FLab_4$__str_3$0$0({30}DA30d,SC:S),D,0,0
S:FLab_4$__str_4$0$0({47}DA47d,SC:S),D,0,0
S:FLab_4$__str_5$0$0({51}DA51d,SC:S),D,0,0
S:FLab_4$__str_6$0$0({31}DA31d,SC:S),D,0,0
S:FLab_4$__str_7$0$0({41}DA41d,SC:S),D,0,0
S:FLab_4$__str_8$0$0({47}DA47d,SC:S),D,0,0
S:FLab_4$__str_9$0$0({20}DA20d,SC:S),D,0,0
S:FLab_4$__str_10$0$0({89}DA89d,SC:S),D,0,0
S:FLab_4$__str_11$0$0({79}DA79d,SC:S),D,0,0
S:FLab_4$__str_12$0$0({21}DA21d,SC:S),D,0,0
