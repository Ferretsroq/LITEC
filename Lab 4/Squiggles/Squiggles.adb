...
S:LSquiggles.Pick_Heading$input$1$149({1}SC:S),R,0,0,[r7]
S:LSquiggles.read_compass$addr$1$152({1}SC:U),R,0,0,[]
S:LSquiggles.read_compass$Data$1$152({2}DA2d,SC:U),E,0,0
S:LSquiggles.read_compass$read_heading$1$152({2}SI:U),R,0,0,[]
S:LSquiggles.read_ranger$addr$1$154({1}SC:U),R,0,0,[]
S:LSquiggles.read_ranger$st_range$1$154({2}SI:U),R,0,0,[r6,r7]
S:LSquiggles.Update_Value$incr$1$155({1}SC:U),E,0,0
S:LSquiggles.Update_Value$maxval$1$155({2}SI:S),E,0,0
S:LSquiggles.Update_Value$minval$1$155({2}SI:S),E,0,0
S:LSquiggles.Update_Value$Constant$1$155({2}SI:S),R,0,0,[r6,r7]
S:LSquiggles.Update_Value$deflt$1$156({2}SI:S),R,0,0,[r4,r5]
S:LSquiggles.Update_Value$input$1$156({1}SC:S),R,0,0,[r3]
S:LSquiggles.set_COMPASS_PW$Error$1$161({2}SI:S),R,0,0,[r6,r7]
...
S:G$Pick_Compass_Gain$0$0({2}DF,SV:S),C,0,0
...
S:FSquiggles$__str_9$0$0({43}DA43d,SC:S),D,0,0
S:FSquiggles$__str_10$0$0({80}DA80d,SC:S),D,0,0
S:FSquiggles$__str_11$0$0({34}DA34d,SC:S),D,0,0
S:FSquiggles$__str_12$0$0({68}DA68d,SC:S),D,0,0
S:FSquiggles$__str_13$0$0({21}DA21d,SC:S),D,0,0
S:FSquiggles$__str_14$0$0({22}DA22d,SC:S),D,0,0
