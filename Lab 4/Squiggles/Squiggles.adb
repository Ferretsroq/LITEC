...
S:LSquiggles.Pick_Heading$input$1$148({1}SC:S),R,0,0,[r7]
S:LSquiggles.Pick_Compass_Gain$input$1$151({1}SC:S),R,0,0,[r7]
S:LSquiggles.read_compass$addr$1$154({1}SC:U),R,0,0,[]
S:LSquiggles.read_compass$Data$1$154({2}DA2d,SC:U),E,0,0
S:LSquiggles.read_compass$read_heading$1$154({2}SI:U),R,0,0,[]
S:LSquiggles.read_ranger$addr$1$156({1}SC:U),R,0,0,[]
S:LSquiggles.read_ranger$st_range$1$156({2}SI:U),R,0,0,[r6,r7]
S:LSquiggles.Update_Value$incr$1$157({1}SC:U),E,0,0
S:LSquiggles.Update_Value$maxval$1$157({2}SI:S),E,0,0
S:LSquiggles.Update_Value$minval$1$157({2}SI:S),E,0,0
S:LSquiggles.Update_Value$Constant$1$157({2}SI:S),R,0,0,[r6,r7]
S:LSquiggles.Update_Value$deflt$1$158({2}SI:S),R,0,0,[r4,r5]
S:LSquiggles.Update_Value$input$1$158({1}SC:S),R,0,0,[r3]
...
S:FSquiggles$__str_6$0$0({14}DA14d,SC:S),D,0,0
S:FSquiggles$__str_7$0$0({16}DA16d,SC:S),D,0,0
S:FSquiggles$__str_8$0$0({20}DA20d,SC:S),D,0,0
S:FSquiggles$__str_9$0$0({26}DA26d,SC:S),D,0,0
S:FSquiggles$__str_10$0$0({34}DA34d,SC:S),D,0,0
S:FSquiggles$__str_11$0$0({68}DA68d,SC:S),D,0,0
S:FSquiggles$__str_12$0$0({21}DA21d,SC:S),D,0,0
S:FSquiggles$__str_13$0$0({22}DA22d,SC:S),D,0,0
S:FSquiggles$__str_14$0$0({40}DA40d,SC:S),D,0,0
S:FSquiggles$__str_15$0$0({56}DA56d,SC:S),D,0,0
S:FSquiggles$__str_16$0$0({20}DA20d,SC:S),D,0,0
S:FSquiggles$__str_17$0$0({30}DA30d,SC:S),D,0,0
