...
S:LSquiggles.Pick_Heading$user_heading$1$142({2}SI:S),R,0,0,[r6,r7]
S:LSquiggles.Pick_Compass_Gain$user_gain$1$146({2}SI:S),R,0,0,[r6,r7]
S:LSquiggles.read_compass$addr$1$148({1}SC:U),R,0,0,[]
S:LSquiggles.read_compass$Data$1$148({2}DA2d,SC:U),E,0,0
S:LSquiggles.read_compass$read_heading$1$148({2}SI:U),R,0,0,[]
S:LSquiggles.read_ranger$addr$1$150({1}SC:U),R,0,0,[]
S:LSquiggles.read_ranger$st_range$1$150({2}SI:U),R,0,0,[r6,r7]
S:LSquiggles.set_COMPASS_PW$Error$1$156({2}SI:S),R,0,0,[r6,r7]
