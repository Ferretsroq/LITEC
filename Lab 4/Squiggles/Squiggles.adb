...
S:LSquiggles.Pick_Heading$user_heading$1$148({2}SI:S),R,0,0,[r6,r7]
S:LSquiggles.Pick_Compass_Gain$user_gain$1$152({2}SI:S),R,0,0,[r6,r7]
...
S:LSquiggles.set_COMPASS_PW$Error$1$162({2}SI:S),R,0,0,[r6,r7]
...
S:FSquiggles$__str_4$0$0({16}DA16d,SC:S),D,0,0
...
S:FSquiggles$__str_8$0$0({30}DA30d,SC:S),D,0,0
S:FSquiggles$__str_9$0$0({41}DA41d,SC:S),D,0,0
S:FSquiggles$__str_10$0$0({24}DA24d,SC:S),D,0,0
S:FSquiggles$__str_11$0$0({38}DA38d,SC:S),D,0,0
S:FSquiggles$__str_12$0$0({29}DA29d,SC:S),D,0,0
