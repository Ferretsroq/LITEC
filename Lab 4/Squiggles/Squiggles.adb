...
S:LSquiggles.Pick_Heading$user_heading$1$149({2}SI:S),R,0,0,[r6,r7]
S:LSquiggles.Pick_Compass_Gain$user_gain$1$153({2}SI:S),R,0,0,[r6,r7]
S:LSquiggles.read_compass$addr$1$155({1}SC:U),R,0,0,[]
S:LSquiggles.read_compass$Data$1$155({2}DA2d,SC:U),E,0,0
S:LSquiggles.read_compass$read_heading$1$155({2}SI:U),R,0,0,[]
S:LSquiggles.read_ranger$addr$1$157({1}SC:U),R,0,0,[]
S:LSquiggles.read_ranger$st_range$1$157({2}SI:U),R,0,0,[r6,r7]
S:LSquiggles.set_COMPASS_PW$Error$1$159({2}SI:S),R,0,0,[r6,r7]
...
S:FSquiggles$__str_10$0$0({41}DA41d,SC:S),D,0,0
S:FSquiggles$__str_11$0$0({24}DA24d,SC:S),D,0,0
S:FSquiggles$__str_12$0$0({38}DA38d,SC:S),D,0,0
S:FSquiggles$__str_13$0$0({29}DA29d,SC:S),D,0,0
