...
S:LSquiggles.lcd_print$fmt$1$72({3}DG,SC:S),B,1,-5
S:LSquiggles.lcd_print$len$1$73({1}SC:U),R,0,0,[r6]
S:LSquiggles.lcd_print$i$1$73({1}SC:U),R,0,0,[]
S:LSquiggles.lcd_print$ap$1$73({1}DD,SC:U),R,0,0,[]
...
F:G$Update_Value$0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$set_COMPASS_PW$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:LSquiggles.getchar$c$1$39({1}SC:S),R,0,0,[]
S:LSquiggles.lcd_clear$NumBytes$1$77({1}SC:U),E,0,0
S:LSquiggles.lcd_clear$Cmd$1$77({2}DA2d,SC:U),E,0,0
S:LSquiggles.read_keypad$i$1$78({1}SC:U),R,0,0,[r7]
S:LSquiggles.read_keypad$Data$1$78({2}DA2d,SC:U),E,0,0
S:LSquiggles.kpd_input$mode$1$80({1}SC:S),R,0,0,[r7]
S:LSquiggles.kpd_input$sum$1$81({2}SI:U),R,0,0,[r5,r6]
S:LSquiggles.kpd_input$key$1$81({1}SC:S),R,0,0,[r3]
S:LSquiggles.kpd_input$i$1$81({1}SC:S),R,0,0,[]
S:LSquiggles.i2c_write_data$start_reg$1$97({1}SC:U),E,0,0
S:LSquiggles.i2c_write_data$buffer$1$97({3}DG,SC:U),E,0,0
S:LSquiggles.i2c_write_data$num_bytes$1$97({1}SC:U),E,0,0
S:LSquiggles.i2c_write_data$addr$1$97({1}SC:U),R,0,0,[r7]
S:LSquiggles.i2c_write_data$i$1$98({1}SC:U),R,0,0,[]
S:LSquiggles.i2c_read_data$start_reg$1$99({1}SC:U),E,0,0
S:LSquiggles.i2c_read_data$buffer$1$99({3}DG,SC:U),E,0,0
S:LSquiggles.i2c_read_data$num_bytes$1$99({1}SC:U),E,0,0
S:LSquiggles.i2c_read_data$addr$1$99({1}SC:U),R,0,0,[r7]
S:LSquiggles.i2c_read_data$j$1$100({1}SC:U),R,0,0,[]
S:LSquiggles.Accel_Init$Data2$1$103({1}DA1d,SC:U),E,0,0
...
S:G$compass_gain$0$0({4}SF:S),E,0,0
...
S:G$COMPASS_PW$0$0({2}SI:U),E,0,0
S:G$range_adj$0$0({2}SI:U),E,0,0
S:G$compass_adj$0$0({2}SI:U),E,0,0
S:G$ranger_gain$0$0({1}SC:U),E,0,0
S:G$AD_Result$0$0({1}SC:U),E,0,0
S:G$voltage$0$0({1}SC:U),E,0,0
S:G$Data$0$0({2}DA2d,SC:U),E,0,0
S:G$print_delay$0$0({1}SC:U),E,0,0
S:LSquiggles.Pick_Heading$user_heading$1$150({2}SI:S),R,0,0,[r6,r7]
S:LSquiggles.Pick_Compass_Gain$user_gain$1$154({2}SI:S),R,0,0,[r6,r7]
S:LSquiggles.read_compass$addr$1$156({1}SC:U),R,0,0,[]
S:LSquiggles.read_compass$Data$1$156({2}DA2d,SC:U),E,0,0
S:LSquiggles.read_compass$read_heading$1$156({2}SI:U),R,0,0,[]
S:LSquiggles.read_ranger$addr$1$158({1}SC:U),R,0,0,[]
S:LSquiggles.read_ranger$st_range$1$158({2}SI:U),R,0,0,[r6,r7]
S:LSquiggles.Update_Value$incr$1$159({1}SC:U),E,0,0
S:LSquiggles.Update_Value$maxval$1$159({2}SI:S),E,0,0
S:LSquiggles.Update_Value$minval$1$159({2}SI:S),E,0,0
S:LSquiggles.Update_Value$Constant$1$159({2}SI:S),R,0,0,[r6,r7]
S:LSquiggles.Update_Value$deflt$1$160({2}SI:S),R,0,0,[r4,r5]
S:LSquiggles.Update_Value$input$1$160({1}SC:S),R,0,0,[r3]
S:LSquiggles.set_COMPASS_PW$Error$1$166({2}SI:S),R,0,0,[r6,r7]
S:LSquiggles.lcd_print$text$1$73({80}DA80d,SC:U),F,0,0
...
S:G$COMPASS_SWITCH$0$0({1}SX:U),J,0,0
S:G$RANGER_SWITCH$0$0({1}SX:U),J,0,0
...
S:G$Pick_Ranger_Gain$0$0({2}DF,SC:S),C,0,0
S:G$set_range_adj$0$0({2}DF,SV:S),C,0,0
S:G$compass_error$0$0({2}DF,SI:S),C,0,0
S:G$main$0$0({2}DF,SV:S),C,0,0
S:FSquiggles$__str_0$0$0({22}DA22d,SC:S),D,0,0
S:FSquiggles$__str_1$0$0({16}DA16d,SC:S),D,0,0
S:FSquiggles$__str_2$0$0({3}DA3d,SC:S),D,0,0
S:FSquiggles$__str_3$0$0({9}DA9d,SC:S),D,0,0
S:FSquiggles$__str_4$0$0({33}DA33d,SC:S),D,0,0
S:FSquiggles$__str_5$0$0({43}DA43d,SC:S),D,0,0
S:FSquiggles$__str_6$0$0({12}DA12d,SC:S),D,0,0
S:FSquiggles$__str_7$0$0({14}DA14d,SC:S),D,0,0
S:FSquiggles$__str_8$0$0({16}DA16d,SC:S),D,0,0
S:FSquiggles$__str_9$0$0({14}DA14d,SC:S),D,0,0
S:FSquiggles$__str_10$0$0({43}DA43d,SC:S),D,0,0
S:FSquiggles$__str_11$0$0({79}DA79d,SC:S),D,0,0
S:FSquiggles$__str_12$0$0({36}DA36d,SC:S),D,0,0
S:FSquiggles$__str_13$0$0({41}DA41d,SC:S),D,0,0
S:FSquiggles$__str_14$0$0({24}DA24d,SC:S),D,0,0
S:FSquiggles$__str_15$0$0({38}DA38d,SC:S),D,0,0
S:FSquiggles$__str_16$0$0({29}DA29d,SC:S),D,0,0
