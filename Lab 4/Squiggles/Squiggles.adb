...
F:G$set_range_adj$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$compass_error$0$0({2}DF,SI:S),Z,0,0,0,0,0
...
S:LSquiggles.Pick_Heading$user_heading$1$144({2}SI:S),R,0,0,[r6,r7]
S:LSquiggles.Pick_Compass_Gain$user_gain$1$148({2}SI:S),R,0,0,[r6,r7]
S:LSquiggles.read_compass$addr$1$150({1}SC:U),R,0,0,[]
S:LSquiggles.read_compass$Data$1$150({2}DA2d,SC:U),E,0,0
S:LSquiggles.read_compass$read_heading$1$150({2}SI:U),R,0,0,[]
S:LSquiggles.read_ranger$addr$1$152({1}SC:U),R,0,0,[]
S:LSquiggles.read_ranger$Data$1$152({2}DA2d,SC:U),E,0,0
S:LSquiggles.read_ranger$st_range$1$152({2}SI:U),R,0,0,[r6,r7]
S:LSquiggles.compass_error$heading$1$157({2}SI:U),R,0,0,[r6,r7]
S:LSquiggles.compass_error$Error$1$158({2}SI:S),R,0,0,[r6,r7]
S:LSquiggles.compass_error$PWMe$1$158({2}SI:U),R,0,0,[r6,r7]
...
S:FSquiggles$__str_6$0$0({18}DA18d,SC:S),D,0,0
S:FSquiggles$__str_7$0$0({12}DA12d,SC:S),D,0,0
S:FSquiggles$__str_8$0$0({20}DA20d,SC:S),D,0,0
S:FSquiggles$__str_9$0$0({21}DA21d,SC:S),D,0,0
S:FSquiggles$__str_10$0$0({24}DA24d,SC:S),D,0,0
S:FSquiggles$__str_11$0$0({30}DA30d,SC:S),D,0,0
S:FSquiggles$__str_12$0$0({41}DA41d,SC:S),D,0,0
S:FSquiggles$__str_13$0$0({24}DA24d,SC:S),D,0,0
S:FSquiggles$__str_14$0$0({38}DA38d,SC:S),D,0,0
S:FSquiggles$__str_15$0$0({29}DA29d,SC:S),D,0,0
S:FSquiggles$__str_16$0$0({33}DA33d,SC:S),D,0,0
S:FSquiggles$__str_17$0$0({32}DA32d,SC:S),D,0,0
S:FSquiggles$__str_18$0$0({34}DA34d,SC:S),D,0,0
S:FSquiggles$__str_19$0$0({28}DA28d,SC:S),D,0,0
S:FSquiggles$__str_20$0$0({18}DA18d,SC:S),D,0,0
