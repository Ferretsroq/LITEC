...
;--------------------------------------------------------
	.area DSEG    (DATA)
LMyLab4.lcd_clear$NumBytes$1$77==.
_lcd_clear_NumBytes_1_77:
	.ds 1
LMyLab4.lcd_clear$Cmd$1$77==.
_lcd_clear_Cmd_1_77:
	.ds 2
LMyLab4.read_keypad$Data$1$78==.
_read_keypad_Data_1_78:
	.ds 2
LMyLab4.i2c_write_data$start_reg$1$97==.
_i2c_write_data_PARM_2:
	.ds 1
LMyLab4.i2c_write_data$buffer$1$97==.
_i2c_write_data_PARM_3:
	.ds 3
LMyLab4.i2c_write_data$num_bytes$1$97==.
_i2c_write_data_PARM_4:
	.ds 1
LMyLab4.i2c_read_data$start_reg$1$99==.
_i2c_read_data_PARM_2:
	.ds 1
LMyLab4.i2c_read_data$buffer$1$99==.
_i2c_read_data_PARM_3:
	.ds 3
LMyLab4.i2c_read_data$num_bytes$1$99==.
_i2c_read_data_PARM_4:
	.ds 1
LMyLab4.Accel_Init$Data2$1$103==.
