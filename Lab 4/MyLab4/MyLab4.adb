...
S:G$heading_delay$0$0({1}SC:S),E,0,0
S:G$new_heading$0$0({1}SC:S),E,0,0
S:G$new_range$0$0({1}SC:S),E,0,0
S:G$heading$0$0({2}SI:S),E,0,0
S:G$PW$0$0({2}SI:S),E,0,0
S:LMyLab4.Pick_Heading$user_heading$1$131({2}SI:S),R,0,0,[r6,r7]
S:LMyLab4.Pick_Compass_Gain$user_gain$1$135({2}SI:S),R,0,0,[r6,r7]
S:LMyLab4.read_compass$addr$1$137({1}SC:U),R,0,0,[]
S:LMyLab4.read_compass$Data$1$137({2}DA2d,SC:U),E,0,0
S:LMyLab4.read_compass$read_heading$1$137({2}SI:U),R,0,0,[]
...
S:FMyLab4$__str_6$0$0({30}DA30d,SC:S),D,0,0
S:FMyLab4$__str_7$0$0({41}DA41d,SC:S),D,0,0
S:FMyLab4$__str_8$0$0({38}DA38d,SC:S),D,0,0
