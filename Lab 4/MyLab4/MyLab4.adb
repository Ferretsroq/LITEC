...
S:LMyLab4.lcd_print$fmt$1$72({3}DG,SC:S),B,1,-5
S:LMyLab4.lcd_print$len$1$73({1}SC:U),R,0,0,[r6]
S:LMyLab4.lcd_print$i$1$73({1}SC:U),R,0,0,[]
S:LMyLab4.lcd_print$ap$1$73({1}DD,SC:U),R,0,0,[]
...
S:LMyLab4.getchar$c$1$39({1}SC:S),R,0,0,[]
S:LMyLab4.lcd_clear$NumBytes$1$77({1}SC:U),E,0,0
S:LMyLab4.lcd_clear$Cmd$1$77({2}DA2d,SC:U),E,0,0
S:LMyLab4.read_keypad$i$1$78({1}SC:U),R,0,0,[r7]
S:LMyLab4.read_keypad$Data$1$78({2}DA2d,SC:U),E,0,0
S:LMyLab4.kpd_input$mode$1$80({1}SC:S),R,0,0,[r7]
S:LMyLab4.kpd_input$sum$1$81({2}SI:U),R,0,0,[r5,r6]
S:LMyLab4.kpd_input$key$1$81({1}SC:S),R,0,0,[r3]
S:LMyLab4.kpd_input$i$1$81({1}SC:S),R,0,0,[]
S:LMyLab4.i2c_write_data$start_reg$1$97({1}SC:U),E,0,0
S:LMyLab4.i2c_write_data$buffer$1$97({3}DG,SC:U),E,0,0
S:LMyLab4.i2c_write_data$num_bytes$1$97({1}SC:U),E,0,0
S:LMyLab4.i2c_write_data$addr$1$97({1}SC:U),R,0,0,[r7]
S:LMyLab4.i2c_write_data$i$1$98({1}SC:U),R,0,0,[]
S:LMyLab4.i2c_read_data$start_reg$1$99({1}SC:U),E,0,0
S:LMyLab4.i2c_read_data$buffer$1$99({3}DG,SC:U),E,0,0
S:LMyLab4.i2c_read_data$num_bytes$1$99({1}SC:U),E,0,0
S:LMyLab4.i2c_read_data$addr$1$99({1}SC:U),R,0,0,[r7]
S:LMyLab4.i2c_read_data$j$1$100({1}SC:U),R,0,0,[]
S:LMyLab4.Accel_Init$Data2$1$103({1}DA1d,SC:U),E,0,0
...
S:G$h_count$0$0({1}SC:S),E,0,0
S:G$r_count$0$0({1}SC:S),E,0,0
S:G$delay$0$0({1}SC:S),E,0,0
S:G$new_heading$0$0({1}SC:S),E,0,0
S:G$new_range$0$0({1}SC:S),E,0,0
S:G$heading$0$0({2}SI:S),E,0,0
S:G$PW$0$0({2}SI:S),E,0,0
S:G$AD_Result$0$0({1}SC:U),E,0,0
S:G$voltage$0$0({1}SC:U),E,0,0
S:LMyLab4.Pick_Heading$user_heading$1$134({2}SI:S),R,0,0,[r6,r7]
S:LMyLab4.Pick_Compass_Gain$user_gain$1$138({2}SI:S),R,0,0,[r6,r7]
S:LMyLab4.read_compass$addr$1$140({1}SC:U),R,0,0,[]
S:LMyLab4.read_compass$Data$1$140({2}DA2d,SC:U),E,0,0
S:LMyLab4.read_compass$read_heading$1$140({2}SI:U),R,0,0,[]
S:LMyLab4.lcd_print$text$1$73({80}DA80d,SC:U),F,0,0
...
S:FMyLab4$__str_0$0$0({22}DA22d,SC:S),D,0,0
S:FMyLab4$__str_1$0$0({16}DA16d,SC:S),D,0,0
S:FMyLab4$__str_2$0$0({3}DA3d,SC:S),D,0,0
S:FMyLab4$__str_3$0$0({9}DA9d,SC:S),D,0,0
S:FMyLab4$__str_4$0$0({5}DA5d,SC:S),D,0,0
S:FMyLab4$__str_5$0$0({18}DA18d,SC:S),D,0,0
S:FMyLab4$__str_6$0$0({24}DA24d,SC:S),D,0,0
S:FMyLab4$__str_7$0$0({30}DA30d,SC:S),D,0,0
S:FMyLab4$__str_8$0$0({41}DA41d,SC:S),D,0,0
S:FMyLab4$__str_9$0$0({38}DA38d,SC:S),D,0,0
