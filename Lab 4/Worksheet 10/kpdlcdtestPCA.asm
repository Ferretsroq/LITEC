...
;------------------------------------------------------------
;kpdTest                   Allocated to registers r6 r7 
;------------------------------------------------------------
	G$main$0$0 ==.
...
;real_keypad               Allocated to registers r7 
;------------------------------------------------------------
	G$KeyResult$0$0 ==.
