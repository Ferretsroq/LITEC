...
S:LkpdlcdtestPCA.lcd_print$fmt$1$72({3}DG,SC:S),B,1,-5
S:LkpdlcdtestPCA.lcd_print$len$1$73({1}SC:U),R,0,0,[r6]
S:LkpdlcdtestPCA.lcd_print$i$1$73({1}SC:U),R,0,0,[]
S:LkpdlcdtestPCA.lcd_print$ap$1$73({1}DD,SC:U),R,0,0,[]
...
F:G$KeyResult$0$0({2}DF,SC:S),Z,0,0,0,0,0
S:LkpdlcdtestPCA.getchar$c$1$39({1}SC:S),R,0,0,[]
S:LkpdlcdtestPCA.lcd_clear$NumBytes$1$77({1}SC:U),E,0,0
S:LkpdlcdtestPCA.lcd_clear$Cmd$1$77({2}DA2d,SC:U),E,0,0
S:LkpdlcdtestPCA.read_keypad$i$1$78({1}SC:U),R,0,0,[r7]
S:LkpdlcdtestPCA.read_keypad$Data$1$78({2}DA2d,SC:U),E,0,0
S:LkpdlcdtestPCA.kpd_input$mode$1$80({1}SC:S),R,0,0,[r7]
S:LkpdlcdtestPCA.kpd_input$sum$1$81({2}SI:U),R,0,0,[r5,r6]
S:LkpdlcdtestPCA.kpd_input$key$1$81({1}SC:S),R,0,0,[r3]
S:LkpdlcdtestPCA.kpd_input$i$1$81({1}SC:S),R,0,0,[]
S:LkpdlcdtestPCA.i2c_write_data$start_reg$1$97({1}SC:U),E,0,0
S:LkpdlcdtestPCA.i2c_write_data$buffer$1$97({3}DG,SC:U),E,0,0
S:LkpdlcdtestPCA.i2c_write_data$num_bytes$1$97({1}SC:U),E,0,0
S:LkpdlcdtestPCA.i2c_write_data$addr$1$97({1}SC:U),R,0,0,[r7]
S:LkpdlcdtestPCA.i2c_write_data$i$1$98({1}SC:U),R,0,0,[]
S:LkpdlcdtestPCA.i2c_read_data$start_reg$1$99({1}SC:U),E,0,0
S:LkpdlcdtestPCA.i2c_read_data$buffer$1$99({3}DG,SC:U),E,0,0
S:LkpdlcdtestPCA.i2c_read_data$num_bytes$1$99({1}SC:U),E,0,0
S:LkpdlcdtestPCA.i2c_read_data$addr$1$99({1}SC:U),R,0,0,[r7]
S:LkpdlcdtestPCA.i2c_read_data$j$1$100({1}SC:U),R,0,0,[]
S:LkpdlcdtestPCA.Accel_Init$Data2$1$103({1}DA1d,SC:U),E,0,0
...
S:LkpdlcdtestPCA.main$result$1$113({2}SI:S),R,0,0,[r7,r5]
...
S:FkpdlcdtestPCA$__str_5$0$0({13}DA13d,SC:S),D,0,0
