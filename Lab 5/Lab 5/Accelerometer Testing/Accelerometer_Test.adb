...
S:LAccelerometer_Test.lcd_print$fmt$1$72({3}DG,SC:S),B,1,-5
S:LAccelerometer_Test.lcd_print$len$1$73({1}SC:U),R,0,0,[r6]
S:LAccelerometer_Test.lcd_print$i$1$73({1}SC:U),R,0,0,[]
S:LAccelerometer_Test.lcd_print$ap$1$73({1}DD,SC:U),R,0,0,[]
...
S:LAccelerometer_Test.getchar$c$1$39({1}SC:S),R,0,0,[]
S:LAccelerometer_Test.lcd_clear$NumBytes$1$77({1}SC:U),E,0,0
S:LAccelerometer_Test.lcd_clear$Cmd$1$77({2}DA2d,SC:U),E,0,0
S:LAccelerometer_Test.read_keypad$i$1$78({1}SC:U),R,0,0,[r7]
S:LAccelerometer_Test.read_keypad$Data$1$78({2}DA2d,SC:U),E,0,0
S:LAccelerometer_Test.kpd_input$mode$1$80({1}SC:S),R,0,0,[r7]
S:LAccelerometer_Test.kpd_input$sum$1$81({2}SI:U),R,0,0,[r5,r6]
S:LAccelerometer_Test.kpd_input$key$1$81({1}SC:S),R,0,0,[r3]
S:LAccelerometer_Test.kpd_input$i$1$81({1}SC:S),R,0,0,[]
S:LAccelerometer_Test.i2c_write_data$start_reg$1$97({1}SC:U),E,0,0
S:LAccelerometer_Test.i2c_write_data$buffer$1$97({3}DG,SC:U),E,0,0
S:LAccelerometer_Test.i2c_write_data$num_bytes$1$97({1}SC:U),E,0,0
S:LAccelerometer_Test.i2c_write_data$addr$1$97({1}SC:U),R,0,0,[r7]
S:LAccelerometer_Test.i2c_write_data$i$1$98({1}SC:U),R,0,0,[]
S:LAccelerometer_Test.i2c_read_data$start_reg$1$99({1}SC:U),E,0,0
S:LAccelerometer_Test.i2c_read_data$buffer$1$99({3}DG,SC:U),E,0,0
S:LAccelerometer_Test.i2c_read_data$num_bytes$1$99({1}SC:U),E,0,0
...
S:G$gx_adj$0$0({1}SC:S),E,0,0
S:G$gy_adj$0$0({1}SC:S),E,0,0
S:LAccelerometer_Test.status_reg_a$Data$1$132({2}DA2d,SC:U),E,0,0
S:LAccelerometer_Test.status_reg_a$addr$1$132({1}SC:U),R,0,0,[]
...
S:G$status_reg_a$0$0({2}DF,SC:U),C,0,0
S:FAccelerometer_Test$__str_0$0$0({22}DA22d,SC:S),D,0,0
S:FAccelerometer_Test$__str_1$0$0({16}DA16d,SC:S),D,0,0
S:FAccelerometer_Test$__str_2$0$0({3}DA3d,SC:S),D,0,0
S:FAccelerometer_Test$__str_3$0$0({9}DA9d,SC:S),D,0,0
S:FAccelerometer_Test$__str_4$0$0({43}DA43d,SC:S),D,0,0
S:FAccelerometer_Test$__str_5$0$0({23}DA23d,SC:S),D,0,0
S:FAccelerometer_Test$__str_6$0$0({11}DA11d,SC:S),D,0,0
S:FAccelerometer_Test$__str_7$0$0({12}DA12d,SC:S),D,0,0
