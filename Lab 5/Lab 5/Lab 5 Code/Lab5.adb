...
S:LLab5.status_reg_a$Data$1$155({2}DA2d,SC:U),E,0,0
S:LLab5.status_reg_a$addr$1$155({1}SC:U),R,0,0,[]
S:LLab5.read_accel$Data$1$159({4}DA4d,SC:S),E,0,0
S:LLab5.read_accel$addr$1$159({1}SC:U),E,0,0
S:LLab5.read_accel$x_value$1$159({2}SI:S),E,0,0
S:LLab5.read_accel$y_value$1$159({2}SI:S),R,0,0,[r2,r7]
S:LLab5.read_accel$i$1$159({2}SI:S),R,0,0,[]
S:LLab5.read_accel$j$1$159({1}SC:U),R,0,0,[r6]
