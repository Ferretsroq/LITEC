...
S:G$gx_motor_adj$0$0({2}SI:S),E,0,0
S:G$steer_gain$0$0({4}SF:S),E,0,0
S:G$drive_gain$0$0({4}SF:S),E,0,0
S:G$new_AD$0$0({1}SC:U),E,0,0
S:LLab5.Pick_Steering_Gain$input$1$143({1}SC:S),R,0,0,[r7]
S:LLab5.Pick_Drive_Gain$input$1$146({1}SC:S),R,0,0,[r7]
S:LLab5.status_reg_a$Data$1$156({2}DA2d,SC:U),E,0,0
S:LLab5.status_reg_a$addr$1$156({1}SC:U),R,0,0,[]
S:LLab5.read_accel$Data$1$160({4}DA4d,SC:S),E,0,0
S:LLab5.read_accel$addr$1$160({1}SC:U),E,0,0
S:LLab5.read_accel$x_value$1$160({2}SI:S),E,0,0
S:LLab5.read_accel$y_value$1$160({2}SI:S),R,0,0,[r2,r7]
S:LLab5.read_accel$i$1$160({2}SI:S),R,0,0,[]
S:LLab5.read_accel$j$1$160({1}SC:U),R,0,0,[r6]
...
S:FLab5$__str_11$0$0({31}DA31d,SC:S),D,0,0
S:FLab5$__str_12$0$0({38}DA38d,SC:S),D,0,0
S:FLab5$__str_13$0$0({28}DA28d,SC:S),D,0,0
