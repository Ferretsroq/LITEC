...
F:G$Pick_Drive_Gain$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:G$gx_adj$0$0({2}SI:S),E,0,0
S:G$gy_adj$0$0({2}SI:S),E,0,0
S:G$steer_gain$0$0({4}SF:S),E,0,0
S:G$drive_gain$0$0({4}SF:S),E,0,0
S:G$new_AD$0$0({1}SC:U),E,0,0
S:LLab5.Pick_Steering_Gain$input$1$141({1}SC:S),R,0,0,[r7]
S:LLab5.Pick_Drive_Gain$input$1$144({1}SC:S),R,0,0,[r7]
S:LLab5.status_reg_a$Data$1$153({2}DA2d,SC:U),E,0,0
S:LLab5.status_reg_a$addr$1$153({1}SC:U),R,0,0,[]
S:LLab5.read_accel$Data$1$157({4}DA4d,SC:S),E,0,0
S:LLab5.read_accel$addr$1$157({1}SC:U),E,0,0
S:LLab5.read_accel$x_value$1$157({2}SI:S),E,0,0
S:LLab5.read_accel$y_value$1$157({2}SI:S),R,0,0,[r2,r7]
S:LLab5.read_accel$i$1$157({2}SI:S),R,0,0,[]
S:LLab5.read_accel$j$1$157({1}SC:U),R,0,0,[r6]
...
S:FLab5$__str_5$0$0({46}DA46d,SC:S),D,0,0
S:FLab5$__str_6$0$0({23}DA23d,SC:S),D,0,0
S:FLab5$__str_7$0$0({41}DA41d,SC:S),D,0,0
S:FLab5$__str_8$0$0({56}DA56d,SC:S),D,0,0
S:FLab5$__str_9$0$0({20}DA20d,SC:S),D,0,0
S:FLab5$__str_10$0$0({31}DA31d,SC:S),D,0,0
S:FLab5$__str_11$0$0({38}DA38d,SC:S),D,0,0
S:FLab5$__str_12$0$0({28}DA28d,SC:S),D,0,0
