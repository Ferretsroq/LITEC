...
F:G$Pick_Steering_Gain$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Pick_Drive_Gain$0$0({2}DF,SV:S),C,0,0,0,0,0
...
S:LLab5.getchar$c$1$39({1}SC:S),R,0,0,[]
...
S:G$steer_gain$0$0({1}SC:U),E,0,0
S:G$drive_gain$0$0({1}SC:U),E,0,0
S:LLab5.Pick_Steering_Gain$input$1$140({1}SC:S),R,0,0,[r7]
S:LLab5.Pick_Drive_Gain$input$1$143({1}SC:S),R,0,0,[r7]
S:LLab5.status_reg_a$Data$1$152({2}DA2d,SC:U),E,0,0
S:LLab5.status_reg_a$addr$1$152({1}SC:U),R,0,0,[]
S:LLab5.read_accel$Data$1$156({4}DA4d,SC:U),E,0,0
S:LLab5.read_accel$addr$1$156({1}SC:U),E,0,0
S:LLab5.read_accel$x_value$1$156({2}SI:S),R,0,0,[r3,r4]
S:LLab5.read_accel$y_value$1$156({2}SI:S),R,0,0,[r2,r7]
S:LLab5.read_accel$i$2$157({2}SI:S),R,0,0,[]
...
S:G$Pick_Drive_Gain$0$0({2}DF,SV:S),C,0,0
...
S:FLab5$__str_4$0$0({43}DA43d,SC:S),D,0,0
S:FLab5$__str_5$0$0({21}DA21d,SC:S),D,0,0
S:FLab5$__str_6$0$0({21}DA21d,SC:S),D,0,0
S:FLab5$__str_7$0$0({20}DA20d,SC:S),D,0,0
S:FLab5$__str_8$0$0({17}DA17d,SC:S),D,0,0
S:FLab5$__str_9$0$0({14}DA14d,SC:S),D,0,0
S:FLab5$__str_10$0$0({16}DA16d,SC:S),D,0,0
S:FLab5$__str_11$0$0({26}DA26d,SC:S),D,0,0
S:FLab5$__str_12$0$0({23}DA23d,SC:S),D,0,0
S:FLab5$__str_13$0$0({41}DA41d,SC:S),D,0,0
S:FLab5$__str_14$0$0({52}DA52d,SC:S),D,0,0
S:FLab5$__str_15$0$0({20}DA20d,SC:S),D,0,0
S:FLab5$__str_16$0$0({28}DA28d,SC:S),D,0,0
S:FLab5$__str_17$0$0({38}DA38d,SC:S),D,0,0
S:FLab5$__str_18$0$0({25}DA25d,SC:S),D,0,0
