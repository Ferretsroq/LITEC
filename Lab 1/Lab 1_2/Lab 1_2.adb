...
S:LLab_1_2.getchar$c$1$10({1}SC:S),R,0,0,[]
...
S:G$Debugging$0$0({2}DF,SV:S),C,0,0
S:G$Switch$0$0({2}DF,SI:S),C,0,0
S:G$main$0$0({2}DF,SV:S),C,0,0
S:FLab_1_2$__str_0$0$0({8}DA8d,SC:S),D,0,0
S:FLab_1_2$__str_1$0$0({9}DA9d,SC:S),D,0,0
S:FLab_1_2$__str_2$0$0({22}DA22d,SC:S),D,0,0
S:FLab_1_2$__str_3$0$0({5}DA5d,SC:S),D,0,0
S:FLab_1_2$__str_4$0$0({27}DA27d,SC:S),D,0,0
